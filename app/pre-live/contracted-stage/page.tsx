"use client"
import { ContractedTable } from "@/components/pre-live/contracted-stage/contracted-table"
import { useState } from "react"

export default function ContractedStagePage() {
  ...
  return (
    <div className="px-8 py-6">
      <h1 className="text-gray-900 font-semibold text-xl mb-5">Contracted Stage - Rooftop Overview</h1>
      ...
      <div className="mb-6">
        <ContractedTable activeTab={activeTab} />
      </div>
    </div>
  )
}
