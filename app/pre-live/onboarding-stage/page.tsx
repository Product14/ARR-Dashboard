"use client"
import { OnboardingTable } from "@/components/pre-live/onboarding-stage/onboarding-table"
...
export default function OnboardingStagePage() {
  ...
  const tabs = [
    { id: "studio_ai" as const, label: "Studio AI", count: 1890 },
    { id: "vini_ai" as const, label: "Vini AI", count: 209 },
  ]

  return (
    <div className="px-8 py-6">
      <h1 className="text-gray-900 font-semibold text-xl mb-5">Onboarding Stage - Rooftop Overview</h1>
      ...
      <div className="mb-6">
        <OnboardingTable activeTab={activeTab} />
      </div>
    </div>
  )
}
