export function RooftopsTableHeader() {
  return (
    <thead>
      <tr className="border-b border-gray-200">
        ...
        <th colSpan={2} className="px-4 py-2 text-center border-r border-gray-200">
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-xs text-[#2563eb] font-normal">As of Mar 19, 2026</span>
          </div>
        </th>
        ...
        <th colSpan={2} className="px-4 py-2 text-center">
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-xs text-[#b45309] font-normal">Mar 1 – Mar 19</span>
          </div>
        </th>
      </tr>
